...
function renderBuilder(container) {
  ...
  el.innerHTML = `
    <div class="dash-builder-head">
      <div>
        <div style="font-size:13px;color:var(--red,#C10801);font-weight:700;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:8px">REGISTRO DE FISIO DE</div>
