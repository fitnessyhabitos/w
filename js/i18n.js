...
const translations = {
  es: {
    ...
    salud_affects_training: '⚠️ Afecta al entrenamiento: ',
    ...
    salud_add_modal_general: '❤️ Registro de salud',
    ...
    dark_mode_off:           'Modo claro activado ☀️',
  ...
  en: {
    ...
    salud_affects_training: '⚠️ Affects training: ',
    ...
    salud_add_modal_general: '❤️ Health record',
