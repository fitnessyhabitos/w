...
const ICON = {
  // Píldora/suplemento
  pill: `<svg class="tgwl-icon tgwl-icon-pill" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3" y="8" width="18" height="8" rx="4" stroke="currentColor" stroke-width="1.5"/><line x1="12" y1="8" x2="12" y2="16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  // Cubiertos (comida genérica)
  meal: `<svg class="tgwl-icon tgwl-icon-meal" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M7 3v8a2 2 0 0 0 2 2v8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M7 3v6M5 3v6M9 3v6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M17 3c-1.5 0-3 1-3 4v5h3v9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  // Manzana (media mañana / snack)
  apple: `<svg class="tgwl-icon tgwl-icon-apple" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 7c-1-2-3-3-5-3-3 0-5 2.5-5 6 0 5 4 11 6 11 1 0 2-1 3-1s2 1 3 1c2 0 6-6 6-11 0-3.5-2-6-5-6-2 0-4 1-3 3z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 7c0-2 1-4 3-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  // Sandwich
  sandwich: `<svg class="tgwl-icon tgwl-icon-sandwich" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M3 8l9-4 9 4-9 4-9-4z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M3 13l9 4 9-4" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M3 17l9 4 9-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  // Sol (mañana / wakeup)
  ...
  moon: `<svg class="tgwl-icon tgwl-icon-moon" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>`,
  // Pesas (entreno)
  barbell: `<svg class="tgwl-icon tgwl-icon-barbell" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M6.5 6.5H4a1 1 0 0 0-1 1v9a1 1 0 0 0 1 1h2.5M17.5 6.5H20a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1h-2.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><rect x="6.5" y="4" width="3" height="16" rx="1.5" stroke="currentColor" stroke-width="1.5"/><rect x="14.5" y="4" width="3" height="16" rx="1.5" stroke="currentColor" stroke-width="1.5"/><line x1="9.5" y1="12" x2="14.5" y2="12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  // Rayo (pre-entreno)
  bolt: `<svg class="tgwl-icon tgwl-icon-bolt" viewBox="0 0 24 24" fill="none" aria-hidden="true"><polygon points="13 2 4 14 11 14 10 22 20 10 13 10 13 2" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>`,
  // Refresh (post-entreno)
  refresh: `<svg class="tgwl-icon tgwl-icon-refresh" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M3 12a9 9 0 0 1 15-6.7L21 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 3v5h-5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 21v-5h5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  // Cuenco (ensalada / empty)
  bowl: `<svg class="tgwl-icon tgwl-icon-bowl" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M3 11h18a9 9 0 0 1-18 0z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M7 11a5 5 0 0 1 10 0" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="9" cy="8" r="1" fill="currentColor"/><circle cx="14" cy="7" r="1" fill="currentColor"/><circle cx="12" cy="9.5" r="1" fill="currentColor"/></svg>`,
  // Check (completado)
  check: `<svg class="tgwl-icon tgwl-icon-check" viewBox="0 0 24 24" fill="none" aria-hidden="true"><polyline points="4 12 10 18 20 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  // Círculo vacío
  circle: `<svg class="tgwl-icon tgwl-icon-circle" viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="12" cy="12" r="8.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  // Cerrar
  close: `<svg class="tgwl-icon tgwl-icon-close" viewBox="0 0 24 24" fill="none" aria-hidden="true"><line x1="6" y1="6" x2="18" y2="18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><line x1="18" y1="6" x2="6" y2="18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
};
